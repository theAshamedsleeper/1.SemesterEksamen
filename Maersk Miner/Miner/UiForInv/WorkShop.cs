...
namespace Miner
{
    public abstract class WorkShop
    {
        ...
        private static int r1Copper = 300;
        private static int r2MilitaryScrap = 300;
        private static int r3Titanium = 300;
        private static int r4Plat = 300;
        private static int r5Uranium = 300;
